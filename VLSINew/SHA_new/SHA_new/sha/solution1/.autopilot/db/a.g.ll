; ModuleID = 'C:/Student/SHA_new/sha/solution1/.autopilot/db/a.g.bc'
...
; <label>:70                                      ; preds = %67
  ...
  call void bitcast (void (...)* @_ssdm_Unroll to void (i32, i32, i32, i8*)*)(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !319 ; [debug line = 59:1]
  %71 = load i32* %i, align 4, !dbg !320          ; [#uses=1 type=i32] [debug line = 60:2]
  %72 = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %71, !dbg !320 ; [#uses=1 type=i8*] [debug line = 60:2]
  %73 = load i8* %72, align 1, !dbg !320          ; [#uses=1 type=i8] [debug line = 60:2]
  %74 = load i32* %i, align 4, !dbg !320          ; [#uses=1 type=i32] [debug line = 60:2]
  %75 = load i8** %4, align 4, !dbg !320          ; [#uses=1 type=i8*] [debug line = 60:2]
  %76 = getelementptr inbounds i8* %75, i32 %74, !dbg !320 ; [#uses=1 type=i8*] [debug line = 60:2]
  store i8 %73, i8* %76, align 1, !dbg !320       ; [debug line = 60:2]
  call void bitcast (void (...)* @_ssdm_RegionEnd to void (i8*)*)(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !321 ; [debug line = 61:2]
  br label %77, !dbg !321                         ; [debug line = 61:2]

; <label>:77                                      ; preds = %70
  %78 = load i32* %i, align 4, !dbg !322          ; [#uses=1 type=i32] [debug line = 57:18]
  %79 = add nsw i32 %78, 1, !dbg !322             ; [#uses=1 type=i32] [debug line = 57:18]
  store i32 %79, i32* %i, align 4, !dbg !322      ; [debug line = 57:18]
  br label %67, !dbg !322                         ; [debug line = 57:18]

; <label>:80                                      ; preds = %67
  ret void, !dbg !323                             ; [debug line = 62:1]
}
...
!319 = metadata !{i32 59, i32 1, metadata !317, null}
!320 = metadata !{i32 60, i32 2, metadata !317, null}
!321 = metadata !{i32 61, i32 2, metadata !317, null}
!322 = metadata !{i32 57, i32 18, metadata !315, null}
!323 = metadata !{i32 62, i32 1, metadata !266, null}
