; ModuleID = 'C:/Student/SHA_new/sha/solution2/.autopilot/db/a.g.1.bc'
...
; <label>:2                                       ; preds = %1
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !116 ; [#uses=1 type=i32] [debug line = 36:3]
  ...
  %rend2 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %rbegin1) nounwind, !dbg !120 ; [#uses=0 type=i32] [debug line = 36:76]
...
; <label>:6                                       ; preds = %5
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !148 ; [#uses=1 type=i32] [debug line = 50:30]
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !163 ; [#uses=0 type=i32] [debug line = 62:4]
...
; <label>:2                                       ; preds = %1
  %rbegin9 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !269 ; [#uses=1 type=i32] [debug line = 34:3]
...
; <label>:5                                       ; preds = %.preheader
  %rbegin7 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !285 ; [#uses=1 type=i32] [debug line = 48:3]
  ...
  %rend8 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0), i32 %rbegin7) nounwind, !dbg !289 ; [#uses=0 type=i32] [debug line = 48:50]
...
; <label>:7                                       ; preds = %6, %4
  ...
  %rend10 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0), i32 %rbegin9) nounwind, !dbg !291 ; [#uses=0 type=i32] [debug line = 52:2]
...
; <label>:10                                      ; preds = %9
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !295 ; [#uses=1 type=i32] [debug line = 57:24]
  ...
  %seg_buf.addr.1 = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %i.2, !dbg !298 ; [#uses=1 type=i8*] [debug line = 60:3]
  %seg_buf.load = load i8* %seg_buf.addr.1, align 1, !dbg !298 ; [#uses=2 type=i8] [debug line = 60:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %seg_buf.load) nounwind
  %digest.addr = getelementptr inbounds i8* %digest, i32 %i.2, !dbg !298 ; [#uses=1 type=i8*] [debug line = 60:3]
  store i8 %seg_buf.load, i8* %digest.addr, align 1, !dbg !298 ; [debug line = 60:3]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !299 ; [#uses=0 type=i32] [debug line = 61:2]
  %i = add nsw i32 %i.2, 1, !dbg !300             ; [#uses=1 type=i32] [debug line = 57:18]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !279), !dbg !300 ; [debug line = 57:18] [debug variable = i]
  br label %9, !dbg !300                          ; [debug line = 57:18]

; <label>:11                                      ; preds = %9
  ret void, !dbg !301                             ; [debug line = 62:1]
}
...
!298 = metadata !{i32 60, i32 3, metadata !296, null}
!299 = metadata !{i32 61, i32 2, metadata !296, null}
!300 = metadata !{i32 57, i32 18, metadata !294, null}
!301 = metadata !{i32 62, i32 1, metadata !251, null}
