; ModuleID = 'C:/Student/SHA_new/sha/solution2/.autopilot/db/a.o.2.bc'
...
@.str8 = private unnamed_addr constant [12 x i8] c"hls_label_8\00", align 1 ; [#uses=2 type=[12 x i8]*]
...
.preheader6:                                      ; preds = %3, %.preheader6.preheader
  ...
  %i9.cast6 = zext i7 %i9 to i10, !dbg !251       ; [#uses=1 type=i10] [debug line = 38:9]
  %i9.cast5 = zext i7 %i9 to i32, !dbg !251       ; [#uses=1 type=i32] [debug line = 38:9]
...
; <label>:3                                       ; preds = %.preheader6
  ...
  %tmp1 = add i10 %base_offset.cast, %i9.cast6    ; [#uses=1 type=i10]
  ...
  %seg_buf.addr.1 = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %i9.cast5, !dbg !257 ; [#uses=1 type=i8*] [debug line = 39:5]
  store i8 %data.load, i8* %seg_buf.addr.1, align 1, !dbg !257 ; [debug line = 39:5]
  %i.7 = add i7 %i9, 1, !dbg !258                 ; [#uses=1 type=i7] [debug line = 38:20]
  call void @llvm.dbg.value(metadata !{i7 %i.7}, i64 0, metadata !259), !dbg !258 ; [debug line = 38:20] [debug variable = i]
...
.preheader:                                       ; preds = %5, %.preheader.preheader
  %i.1 = phi i6 [ %i.8, %5 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i6]
  %i.1.cast4 = zext i6 %i.1 to i10, !dbg !254     ; [#uses=1 type=i10] [debug line = 46:9]
...
; <label>:5                                       ; preds = %.preheader
  %base_offset.cast7 = trunc i32 %base_offset to i10 ; [#uses=1 type=i10]
  %tmp2 = add i10 %base_offset.cast7, %i.1.cast4  ; [#uses=1 type=i10]
  ...
  %seg_buf.addr.2 = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %i.1.cast, !dbg !278 ; [#uses=1 type=i8*] [debug line = 48:2]
  store i8 %data.load.4, i8* %seg_buf.addr.2, align 1, !dbg !278 ; [debug line = 48:2]
  %i.8 = add i6 %i.1, 1, !dbg !280                ; [#uses=1 type=i6] [debug line = 46:19]
  call void @llvm.dbg.value(metadata !{i6 %i.8}, i64 0, metadata !259), !dbg !280 ; [debug line = 46:19] [debug variable = i]
...
; <label>:9                                       ; preds = %1
  ...
  br label %10, !dbg !284                         ; [debug line = 57:7]

; <label>:10                                      ; preds = %11, %9
  %i.2 = phi i6 [ 0, %9 ], [ %i, %11 ]            ; [#uses=3 type=i6]
  %i.2.cast3 = zext i6 %i.2 to i32, !dbg !284     ; [#uses=2 type=i32] [debug line = 57:7]
  %exitcond = icmp eq i6 %i.2, -32, !dbg !284     ; [#uses=1 type=i1] [debug line = 57:7]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 32, i64 32, i64 32)
  br i1 %exitcond, label %12, label %11, !dbg !284 ; [debug line = 57:7]

; <label>:11                                      ; preds = %10
  %seg_buf.addr = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %i.2.cast3, !dbg !286 ; [#uses=1 type=i8*] [debug line = 60:3]
  %seg_buf.load = load i8* %seg_buf.addr, align 1, !dbg !286 ; [#uses=1 type=i8] [debug line = 60:3]
  %digest.addr = getelementptr [32 x i8]* %digest, i32 0, i32 %i.2.cast3, !dbg !286 ; [#uses=1 type=i8*] [debug line = 60:3]
  store i8 %seg_buf.load, i8* %digest.addr, align 1, !dbg !286 ; [debug line = 60:3]
  %i = add i6 %i.2, 1, !dbg !288                  ; [#uses=1 type=i6] [debug line = 57:18]
  call void @llvm.dbg.value(metadata !{i6 %i}, i64 0, metadata !259), !dbg !288 ; [debug line = 57:18] [debug variable = i]
  br label %10, !dbg !288                         ; [debug line = 57:18]

; <label>:12                                      ; preds = %10
  ret void, !dbg !289                             ; [debug line = 62:1]
}
...
!27 = metadata !{i32 786449, i32 0, i32 1, metadata !"C:/Student/SHA_new/sha/solution2/.autopilot/db/sha256.pragma.2.c", metadata !"C:\5CStudent\5CSHA_new", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, null, null, null, metadata !28} ; [ DW_TAG_compile_unit ]
...
!284 = metadata !{i32 57, i32 7, metadata !285, null}
!285 = metadata !{i32 786443, metadata !236, i32 57, i32 2, metadata !219, i32 26} ; [ DW_TAG_lexical_block ]
!286 = metadata !{i32 60, i32 3, metadata !287, null}
!287 = metadata !{i32 786443, metadata !285, i32 57, i32 23, metadata !219, i32 27} ; [ DW_TAG_lexical_block ]
!288 = metadata !{i32 57, i32 18, metadata !285, null}
!289 = metadata !{i32 62, i32 1, metadata !236, null}
