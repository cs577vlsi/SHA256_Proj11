...
@p_str8 = private unnamed_addr constant [12 x i8] c"hls_label_8\00", align 1
...
.preheader6:                                      ; preds = %.preheader6.preheader, %3
  %i9 = phi i7 [ %i_7, %3 ], [ 0, %.preheader6.preheader ]
  %i9_cast6 = zext i7 %i9 to i10
  %i9_cast5 = zext i7 %i9 to i32
...
; <label>:3                                       ; preds = %.preheader6
  ...
  %data_load = load i8* %data_addr, align 1
  %seg_buf_addr_1 = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %i9_cast5
  store i8 %data_load, i8* %seg_buf_addr_1, align 1
  br label %.preheader6
...
.preheader:                                       ; preds = %.preheader.preheader, %5
  %i_1 = phi i6 [ %i_8, %5 ], [ 0, %.preheader.preheader ]
  %i_1_cast4 = zext i6 %i_1 to i10
...
; <label>:5                                       ; preds = %.preheader
  ...
  %seg_buf_addr_2 = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %i_1_cast
  store i8 %data_load_4, i8* %seg_buf_addr_2, align 1
  br label %.preheader
...
; <label>:10                                      ; preds = %9
  %seg_buf_addr = getelementptr inbounds [64 x i8]* %seg_buf, i32 0, i32 %i_2_cast3
  %seg_buf_load = load i8* %seg_buf_addr, align 1
  %digest_addr = getelementptr [32 x i8]* %digest, i32 0, i32 %i_2_cast3
