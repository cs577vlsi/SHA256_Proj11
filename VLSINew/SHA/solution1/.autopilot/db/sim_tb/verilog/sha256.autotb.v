...
`define AESL_DEPTH_base_offset 1
`define AESL_DEPTH_bytes 1
`define AESL_DEPTH_digest 1
`define AUTOTB_TVIN_data  "./c.sha256.autotvin_data.dat"
`define AUTOTB_TVIN_base_offset  "./c.sha256.autotvin_base_offset.dat"
`define AUTOTB_TVIN_bytes  "./c.sha256.autotvin_bytes.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.sha256.autotvin_data.dat"
`define AUTOTB_TVIN_base_offset_out_wrapc  "./rtl.sha256.autotvin_base_offset.dat"
`define AUTOTB_TVIN_bytes_out_wrapc  "./rtl.sha256.autotvin_bytes.dat"
`define AUTOTB_TVOUT_digest  "./c.sha256.autotvout_digest.dat"
`define AUTOTB_TVOUT_digest_out_wrapc  "./impl_rtl.sha256.autotvout_digest.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 5;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 58126;
parameter LENGTH_data = 256;
parameter LENGTH_base_offset = 1;
parameter LENGTH_bytes = 1;
parameter LENGTH_digest = 32;
...
reg end_base_offset;
reg [31:0] size_base_offset;
reg [31:0] size_base_offset_backup;
reg end_bytes;
reg [31:0] size_bytes;
reg [31:0] size_bytes_backup;
reg end_digest;
reg [31:0] size_digest;
reg [31:0] size_digest_backup;
...
reg dump_tvout_finish_digest;

initial begin : dump_tvout_runtime_sign_digest
    integer fp;
    dump_tvout_finish_digest = 0;
    fp = $fopen(`AUTOTB_TVOUT_digest_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_digest_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_digest_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_digest_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
