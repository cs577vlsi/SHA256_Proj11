...
// ==============================================================
#ifndef __sha256_transform_k_H__
#define __sha256_transform_k_H__
...
struct sha256_transform_k_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sha256_transform_k_ram) {
...
sha256_transform_k_ram* meminst;


SC_CTOR(sha256_transform_k) {
meminst = new sha256_transform_k_ram("sha256_transform_k_ram");
