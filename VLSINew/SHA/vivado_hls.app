<project xmlns="com.autoesl.autopilot.project" name="SHA" top="sha256">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <solutions xmlns="">
        ...
        <solution name="solution2_array_partition_pipeline" status="inactive"/>
        <solution name="solution2_array_partition" status="inactive"/>
        <solution name="solution2_Kintex_with_hardware" status="active"/>
    </solutions>
</project>
