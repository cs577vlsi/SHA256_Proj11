# 1 "SHA_new/SHA_new/sha256_impl.c"
# 1 "SHA_new/SHA_new/sha256_impl.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "SHA_new/SHA_new/sha256_impl.c" 2
...
# 2 "SHA_new/SHA_new/sha256_impl.c" 2
...
# 4 "SHA_new/SHA_new/sha256_impl.c" 2
...
# 5 "SHA_new/SHA_new/sha256_impl.c" 2
# 18 "SHA_new/SHA_new/sha256_impl.c"
unsigned int k[64] = {
...
_ssdm_SpecArrayPartition( data, 1, "CYCLIC", 4, "");
...
void sha256_update(SHA256_CTX *ctx, unsigned char data[], unsigned int len)
{
   ...
   for (i=0; i < len; ++i) {
_ssdm_op_SpecLoopTripCount(0, 1, 0, "");
...
_ssdm_op_SpecPipeline(2, 1, 1, 0, "");
 ctx->data[i++] = 0x80;
  while (i < 56){
_ssdm_op_SpecLoopTripCount(0, 56, 28, "");
 ctx->data[i++] = 0x00;
  }
 }
 else {
