# 1 "SHA_new/SHA_new/sha256.c"
# 1 "SHA_new/SHA_new/sha256.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "SHA_new/SHA_new/sha256.c" 2
# 1 "SHA_new/SHA_new/sha256.h" 1


# 1 "C:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/include\\stdbool.h" 1 3 4
# 4 "SHA_new/SHA_new/sha256.h" 2
...
# 6 "SHA_new/SHA_new/sha256.c" 2
# 1 "SHA_new/SHA_new/sha256_impl.h" 1
...
# 7 "SHA_new/SHA_new/sha256.c" 2

void sha256( unsigned char data[256],
    unsigned int base_offset,
    unsigned int bytes,
    unsigned char digest[32] ) {_ssdm_SpecArrayDimSize(data, 256);_ssdm_SpecArrayDimSize(digest, 32);
...
_ssdm_op_SpecInterface(base_offset, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(bytes, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");


 unsigned char seg_buf[64];
