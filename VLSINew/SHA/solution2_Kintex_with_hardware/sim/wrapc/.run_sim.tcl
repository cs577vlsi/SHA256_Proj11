...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sha256.autotvin.dat"
	set constFileTvOut       "sha256.autotvout.dat"
	set constFileHdlTvIn     "sha256.autohdltvin.dat"
	set constFileHdlTvOut    "sha256.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
