...
void AESL_WRAP_sha256( char *, signed int , signed int ,  char *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_sha256(i8* %%12, i32 %%18, i32 %%20, i8* %%13) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_106_count);
  AESL_WRAP_sha256(( char *)llvm_cbe_tmp__10, llvm_cbe_tmp__15, llvm_cbe_tmp__17, ( char *)llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__15);
printf("\nArgument  = 0x%X",llvm_cbe_tmp__17);
}
