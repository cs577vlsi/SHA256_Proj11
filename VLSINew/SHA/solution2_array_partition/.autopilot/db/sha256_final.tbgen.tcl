...
set C_modelArgList {
	{ ctx_data_0 int 8 regular {array 16 { 2 0 } 1 1 }  }
	{ ctx_data_1 int 8 regular {array 16 { 2 0 } 1 1 }  }
	{ ctx_data_2 int 8 regular {array 16 { 2 0 } 1 1 }  }
	{ ctx_data_3 int 8 regular {array 16 { 2 0 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "440", "EstimateLatencyMax" : "924",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state3", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_sha256_transform_fu_654"},
			{"State" : "ap_ST_fsm_state7", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_sha256_transform_fu_654"}],
		"Port" : [
			{"Name" : "ctx_data_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_654", "Port" : "data_0"}]},
			{"Name" : "ctx_data_1", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_654", "Port" : "data_1"}]},
			{"Name" : "ctx_data_2", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_654", "Port" : "data_2"}]},
			{"Name" : "ctx_data_3", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_654", "Port" : "data_3"}]},
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_sha256_transform_fu_654", "Port" : "k"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_654", "Parent" : "0", "Child" : ["2", "3"],
		"CDFG" : "sha256_transform",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "419", "EstimateLatencyMax" : "419",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "k", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_654.k_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_sha256_transform_fu_654.m_U", "Parent" : "1"}]}


set ArgLastReadFirstWriteLatency {
	sha256_final {
		ctx_data_0 {Type IO LastRead 1 FirstWrite -1}
		ctx_data_1 {Type IO LastRead 1 FirstWrite -1}
		ctx_data_2 {Type IO LastRead 1 FirstWrite -1}
		ctx_data_3 {Type IO LastRead 1 FirstWrite -1}
		...
		hash {Type O LastRead -1 FirstWrite 6}
	...
	sha256_transform {
		...
		data_0 {Type I LastRead 1 FirstWrite -1}
		data_1 {Type I LastRead 1 FirstWrite -1}
		data_2 {Type I LastRead 1 FirstWrite -1}
		data_3 {Type I LastRead 1 FirstWrite -1}
		k {Type I LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "440", "Max" : "924"}
	, {"Name" : "Interval", "Min" : "440", "Max" : "924"}
]}
...
set Spec2ImplPortList { 
	ctx_data_0 { ap_memory {  { ctx_data_0_address0 mem_address 1 4 }  { ctx_data_0_ce0 mem_ce 1 1 }  { ctx_data_0_we0 mem_we 1 1 }  { ctx_data_0_d0 mem_din 1 8 }  { ctx_data_0_q0 mem_dout 0 8 }  { ctx_data_0_address1 MemPortADDR2 1 4 }  { ctx_data_0_ce1 MemPortCE2 1 1 }  { ctx_data_0_we1 MemPortWE2 1 1 }  { ctx_data_0_d1 MemPortDIN2 1 8 } } }
	ctx_data_1 { ap_memory {  { ctx_data_1_address0 mem_address 1 4 }  { ctx_data_1_ce0 mem_ce 1 1 }  { ctx_data_1_we0 mem_we 1 1 }  { ctx_data_1_d0 mem_din 1 8 }  { ctx_data_1_q0 mem_dout 0 8 }  { ctx_data_1_address1 MemPortADDR2 1 4 }  { ctx_data_1_ce1 MemPortCE2 1 1 }  { ctx_data_1_we1 MemPortWE2 1 1 }  { ctx_data_1_d1 MemPortDIN2 1 8 } } }
	ctx_data_2 { ap_memory {  { ctx_data_2_address0 mem_address 1 4 }  { ctx_data_2_ce0 mem_ce 1 1 }  { ctx_data_2_we0 mem_we 1 1 }  { ctx_data_2_d0 mem_din 1 8 }  { ctx_data_2_q0 mem_dout 0 8 }  { ctx_data_2_address1 MemPortADDR2 1 4 }  { ctx_data_2_ce1 MemPortCE2 1 1 }  { ctx_data_2_we1 MemPortWE2 1 1 }  { ctx_data_2_d1 MemPortDIN2 1 8 } } }
	ctx_data_3 { ap_memory {  { ctx_data_3_address0 mem_address 1 4 }  { ctx_data_3_ce0 mem_ce 1 1 }  { ctx_data_3_we0 mem_we 1 1 }  { ctx_data_3_d0 mem_din 1 8 }  { ctx_data_3_q0 mem_dout 0 8 }  { ctx_data_3_address1 MemPortADDR2 1 4 }  { ctx_data_3_ce1 MemPortCE2 1 1 }  { ctx_data_3_we1 MemPortWE2 1 1 }  { ctx_data_3_d1 MemPortDIN2 1 8 } } }
