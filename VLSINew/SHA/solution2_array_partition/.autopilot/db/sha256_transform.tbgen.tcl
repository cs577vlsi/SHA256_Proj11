...
set C_modelArgList {
	...
	{ data_0 int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ data_1 int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ data_2 int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ data_3 int 8 regular {array 16 { 1 3 } 1 1 }  }
}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "419", "Max" : "419"}
	, {"Name" : "Interval", "Min" : "419", "Max" : "419"}
]}
...
set Spec2ImplPortList { 
	...
	data_0 { ap_memory {  { data_0_address0 mem_address 1 4 }  { data_0_ce0 mem_ce 1 1 }  { data_0_q0 mem_dout 0 8 } } }
	data_1 { ap_memory {  { data_1_address0 mem_address 1 4 }  { data_1_ce0 mem_ce 1 1 }  { data_1_q0 mem_dout 0 8 } } }
	data_2 { ap_memory {  { data_2_address0 mem_address 1 4 }  { data_2_ce0 mem_ce 1 1 }  { data_2_q0 mem_dout 0 8 } } }
	data_3 { ap_memory {  { data_3_address0 mem_address 1 4 }  { data_3_ce0 mem_ce 1 1 }  { data_3_q0 mem_dout 0 8 } } }
}
